...
pos::pos_t ImportSpec::end() const { return path_->end(); }

pos::pos_t ValueSpec::start() const { return names_.front()->start(); }
...
pos::pos_t TypeSpec::start() const { return name_->start(); }

pos::pos_t TypeSpec::end() const { return type_->end(); }
...
pos::pos_t FuncDecl::start() const { return func_type_->start(); }

pos::pos_t FuncDecl::end() const { return body_->end(); }

pos::pos_t DeclStmt::start() const { return decl_->start(); }

pos::pos_t DeclStmt::end() const { return decl_->end(); }
...
pos::pos_t ForStmt::end() const { return body_->end(); }

pos::pos_t ExprSwitchStmt::end() const { return body_->end(); }

pos::pos_t TypeSwitchStmt::end() const { return body_->end(); }

pos::pos_t LabeledStmt::start() const { return label_->start(); }
...
pos::pos_t SelectionExpr::end() const { return selection_->end(); }

pos::pos_t FuncLit::start() const { return type_->start(); }

pos::pos_t FuncLit::end() const { return body_->end(); }
...
pos::pos_t TypeParam::start() const { return name_->start(); }

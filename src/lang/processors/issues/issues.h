...
class Issue {
 public:
  Issue(Origin origin, Severity severity, pos::pos_t position, std::string message);
  Issue(Origin origin, Severity severity, std::vector<pos::pos_t> positions, std::string message);

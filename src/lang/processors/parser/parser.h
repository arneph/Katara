...
class Parser {
 public:
  static ast::File* ParseFile(common::positions::File* file, ast::ASTBuilder& ast_builder,
 ...
 private:
  ...
  ast::Expr* ParsePrimaryExpr(ast::Expr* primary_expr, common::positions::pos_t l_brack,
                              std::vector<ast::Expr*> type_args, common::positions::pos_t r_brack,
  ...
  ast::CallExpr* ParseCallExpr(ast::Expr* func, common::positions::pos_t l_brack,
                               std::vector<ast::Expr*> type_args, common::positions::pos_t r_brack);
  ...
  std::optional<common::positions::pos_t> Consume(tokens::Token tok, bool split_shift_ops = false);

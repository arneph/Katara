...
class Package {
 public:
  ...
  const std::vector<common::positions::File*>& pos_files() const { return pos_files_; }
 ...
 private:
  Package(const common::positions::FileSet* file_set)
  ...
  std::vector<common::positions::File*> pos_files_;

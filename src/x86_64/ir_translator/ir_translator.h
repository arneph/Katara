...
class IRTranslator {
 ...
 private:
  ...
  x86_64::Block* TranslateBlock(ir::Block* ir_block, x86_64::BlockBuilder x86_64_block_builder);

  void TranslateInstr(ir::Instr* ir_instr, ir::Block* ir_block,
                      x86_64::BlockBuilder& x86_64_block_builder);
  void TranslateMovInstr(ir::MovInstr* ir_mov_instr, ir::Block* ir_block,
                         x86_64::BlockBuilder& x86_64_block_builder);
  void TranslateUnaryALInstr(ir::UnaryALInstr* ir_unary_al_instr, ir::Block* ir_block,
                             x86_64::BlockBuilder& x86_64_block_builder);
  void TranslateBinaryALInstr(ir::BinaryALInstr* ir_binary_al_instr, ir::Block* ir_block,
                              x86_64::BlockBuilder& x86_64_block_builder);
  void TranslateCompareInstr(ir::CompareInstr* ir_compare_instr, ir::Block* ir_block,
                             x86_64::BlockBuilder& x86_64_block_builder);
  void TranslateJumpInstr(ir::JumpInstr* ir_jump_instr, ir::Block* ir_block,
                          x86_64::BlockBuilder& x86_64_block_builder);
  void TranslateJumpCondInstr(ir::JumpCondInstr* ir_jump_cond_instr, ir::Block* ir_block,
                              x86_64::BlockBuilder& x86_64_block_builder);
  void TranslateCallInstr(ir::CallInstr* ir_call_instr, ir::Block* ir_block,
                          x86_64::BlockBuilder& x86_64_block_builder);
  void TranslateReturnInstr(ir::ReturnInstr* ir_return_instr, ir::Block* ir_block,
                            x86_64::BlockBuilder& x86_64_block_builder);
  ...
  void GenerateMovs(ir::Computed ir_result, ir::Value ir_origin, ir::Block* ir_block,
                    x86_64::BlockBuilder& x86_64_block_builder);

...
private:
    ...
    ir::UnaryALInstr * ParseUnaryALInstr(ir::Computed result,
                                         ir::UnaryALOperation op);
    ir::BinaryALInstr * ParseBinaryALInstr(ir::Computed result,
                                           ir::BinaryALOperation op);
    ir::CompareInstr * ParseCompareInstr(ir::Computed result,
    ...
    ir::Value ParseValue(
        ir::Type expected_type = ir::Type::kUnknown);
    ir::Constant ParseConstant(
        ir::Type expected_type = ir::Type::kUnknown);
    ir::Computed ParseComputed(
        ir::Type expected_type = ir::Type::kUnknown);

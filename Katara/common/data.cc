...
data::data(uint8_t *base, int64_t size)
...
data data::view(int64_t start_index,
...
uint8_t& dummy_data::operator[](int64_t index) {
    return dummy_;
}

const uint8_t& dummy_data::operator[](int64_t index) const {
    return dummy_;
}

data dummy_data::view(int64_t start_index) const {
    return *this;
}

data dummy_data::view(int64_t start_index,
                      int64_t end_index) const {
    return *this;
}

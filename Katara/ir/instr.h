...
public:
    UnaryALInstr(UnaryALOperation operation,
                 Computed result,
                 Value operand);
...
public:
    BinaryALInstr(BinaryALOperation operation,
                  Computed result,
                  Value operand_a,
                  Value operand_b);
...
public:
    CompareInstr(CompareOperation operation,
                 Computed result,
                 Value operand_a,
                 Value operand_b);
